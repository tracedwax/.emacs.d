  ...
  ;; (use-package org-ql :after org :straight t)
   ...
   '(org-gtd :url "https://github.com/Trevoke/org-gtd.el"
      ...
      (use-package org-gtd
        ...
        (setq org-gtd-refile-prompt-for-types '(someday))
    ...
    (require 'org-gtd)
  (defun tdw/org-gtd-engage-priority-a ()
    "Display `org-agenda' showing scheduled, Priority A NEXT, and WAIT items."
    (interactive)
    (org-gtd-core-prepare-agenda-buffers)
    (with-org-gtd-context
        (let ((org-agenda-custom-commands
               `(("g" "Scheduled today and Priority A NEXT items"
                  ((agenda ""
                           ((org-agenda-span 1)
                            (org-agenda-start-day nil)
                            (org-agenda-skip-additional-timestamps-same-entry t)))
                   (tags-todo ,(concat "TODO=\"" org-gtd-next "\"+PRIORITY=\"A\"")
                         ((org-agenda-overriding-header "Priority A NEXT actions")
