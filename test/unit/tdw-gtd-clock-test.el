...
;;; Commentary:
;;
;; `tdw-gtd-edit-clock' is the deterministic per-entry CLOCK editor for
;; the adjust-timer workflow: tasks carry several CLOCK chunks by design,
;; so exactly ONE selected entry is edited, never the whole logbook.
